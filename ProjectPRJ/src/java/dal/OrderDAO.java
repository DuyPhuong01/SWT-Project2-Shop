...
public class OrderDAO extends DBContext {
    ...
    public static void main(String[] args) {
        ...
        double sum = monday+tuesday+wednesday+thursday+friday+sunday+saturday;
        DecimalFormat df = new DecimalFormat("#.##");
        System.out.println(df.format(sum));
//        System.out.println(df.format(2.566545664654));
//        System.out.println(100*(double) tuesday/sum);
//        System.out.println(100*(double) wednesday/sum);
//        System.out.println(100*(double) thursday/sum);
//        System.out.println(100*(double) friday/sum);
//        System.out.println( 100*(double) sunday/sum);
//        System.out.println(100*(double) saturday/sum);
    }
}
